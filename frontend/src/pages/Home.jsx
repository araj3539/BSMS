      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-6 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 backdrop-blur-sm"
          />
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <div
        id="book-grid"
        className="container mx-auto px-6 py-12 flex flex-col lg:flex-row gap-10"
      >
        {/* Sidebar */}
        ...
        <main className="flex-1 order-1 lg:order-2">
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {/* FIX: Use 'limit' instead of 6 to fill space correctly */}
              {[...Array(limit)].map((_, i) => (
