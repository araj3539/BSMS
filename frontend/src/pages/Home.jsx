...
function TrustBadge({ icon, title, desc }) {
  return (
    <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-2xl bg-white/50 border border-white/60 shadow-sm backdrop-blur-md hover:bg-white hover:shadow-md transition-all duration-300">
      <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-indigo-50 flex items-center justify-center text-lg md:text-2xl text-indigo-600 shadow-inner flex-shrink-0">
        {icon}
      </div>
...
function CategoryPill({ label, active, onClick }) {
  return (
    <button
      onClick={onClick}
      className={`px-4 md:px-6 py-2 md:py-2.5 rounded-full text-xs md:text-sm font-bold transition-all whitespace-nowrap shadow-sm border ${
        active
    ...
    <div className="relative overflow-hidden rounded-3xl bg-slate-900 p-8 md:p-16 text-center text-white shadow-2xl isolate">
      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-6">
        <h2 className="text-2xl md:text-4xl font-serif font-bold">
          Unlock Secret Chapters
        </h2>
        <p className="text-indigo-200 text-sm md:text-lg">
          Join 10,000+ readers. Get monthly book recommendations and exclusive
          flash sale access.
        </p>
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            placeholder="Enter your email"
            className="flex-1 px-4 md:px-6 py-3 md:py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 backdrop-blur-sm text-sm"
          />
          <button className="px-6 md:px-8 py-3 md:py-4 bg-white text-indigo-900 font-bold rounded-xl hover:bg-indigo-50 transition-colors shadow-lg text-sm">
            Subscribe
          </button>
        </div>
        <p className="text-[10px] md:text-xs text-indigo-400/60">
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-indigo-500 selection:text-white">
      {/* --- HERO SECTION --- */}
      <div className="relative pt-24 pb-12 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
            ...
            >
              ...
              {/* Responsive Heading */}
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-serif font-bold text-slate-900 leading-[1.1] tracking-tight">
              ...
              <p className="text-base md:text-lg text-slate-600 leading-relaxed max-w-xl mx-auto lg:mx-0 px-2 md:px-0">
                A curated sanctuary for book lovers. Discover bestsellers, rare
              ...
              <div className="relative max-w-lg mx-auto lg:mx-0 group px-2 md:px-0">
                ...
                >
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent px-3 md:px-4 py-2 md:py-3 text-slate-900 placeholder-slate-400 font-medium focus:outline-none w-full text-sm md:text-base"
                  />
                  <button className="bg-slate-900 text-white hover:bg-indigo-600 px-4 md:px-6 py-2 md:py-3 rounded-lg font-bold text-sm transition-all shadow-md">
                    Explore
                  </button>
                </form>
              </div>
            ...
            {/* Right: 3D Floating Elements (Hidden on Mobile) */}
            <motion.div
              style={{ y: y1 }}
              ...
              <div className="relative w-[500px] h-[600px] mx-auto perspective-1000">
                ...
                >
                  ...
                  <div className="relative text-center p-6 border-2 border-white/10 m-4 h-[90%] rounded-lg flex flex-col justify-center">
                    <div className="text-xs text-indigo-400 font-bold tracking-[0.2em] mb-2 uppercase">
                      Bestseller
                    </div>
                ...
                >
                  <div className="text-center p-4">
                    <div className="w-16 h-16 bg-rose-100 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl">
                      🌿
                    </div>
      ...
      <div
        id="book-grid"
        className="container mx-auto px-4 md:px-6 py-8 md:py-12 flex flex-col lg:flex-row gap-8 lg:gap-10"
      >
        {/* Sidebar */}
        <aside className="w-full lg:w-72 flex-shrink-0 order-2 lg:order-1">
          <div className="lg:sticky lg:top-28 space-y-8">
            ...
            {/* Promo Card */}
            <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-violet-700 rounded-2xl p-6 text-white shadow-lg text-center group cursor-pointer hidden md:block">
              ...
              <p className="text-sm text-indigo-100 mb-4">
                Get up to 30% off on all fiction bestsellers.
              </p>
        ...
        <main className="flex-1 order-1 lg:order-2">
          ...
          <div className="flex gap-2 md:gap-3 overflow-x-auto pb-4 mb-6 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0">
            <CategoryPill
              label="All Books"
          ...
          {/* Results Header */}
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-6 md:mb-8 gap-4 border-b border-slate-200 pb-4">
            <div>
              ...
              <p className="text-xs md:text-sm text-slate-500 mt-1 font-medium">
                Showing{" "}
                <span className="text-slate-900 font-bold">{books.length}</span>{" "}
                of {total} results
              </p>
            </div>
            ...
            <>
              {books.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
                  ...
                  <p className="text-slate-500 mt-2 mb-6 text-center max-w-xs px-4">
                    We couldn't find matches for your search. Try checking your
              ...
              {totalPages > 1 && (
                <div className="mt-12 md:mt-16 flex justify-center items-center gap-4">
                  <button
                    ...
                    disabled={page <= 1}
                    className="w-10 h-10 flex items-center justify-center rounded-full bg-white border border-slate-200 shadow-sm hover:bg-slate-50 disabled:opacity-50 transition-all font-bold text-slate-600"
                  >
                    ←
                  </button>
