  ...
  return `
    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
      <div style="background-color: #1e293b; padding: 20px; text-align: center;">
        <div style="background-color: #1e293b; padding: 20px; text-align: center;">
  <img src="cid:brand-logo" alt="Store Logo" style="height: 50px; width: auto;" />
</div>
      </div>
      <div style="padding: 24px; background-color: #ffffff;">
        ...
        ${
          orderId
            ? `<div style="background-color: #f8fafc; padding: 12px; border-radius: 6px; margin: 16px 0; text-align: center; font-weight: bold; color: #4f46e5;">Order #${orderId}</div>`
            : ""
        }
        ${
          status
            ? `<p><strong>Current Status:</strong> <span style="text-transform: uppercase; color: #059669;">${status}</span></p>`
            : ""
        }
          ...
          <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 14px;">
            ...
            <tfoot>
              <tr>
                ...
                <td style="padding: 12px 8px 4px; color: #333;">₹${formatMoney(
                  subtotal
                )}</td>
              </tr>
              ${
              ...
              <tr>
                ...
                <td style="padding: 4px 8px; color: #16a34a;">-₹${formatMoney(
                  discount
                )}</td>
              </tr>
              `
              ...
              <tr>
                ...
                <td style="padding: 12px 8px; font-weight: bold; border-top: 1px solid #eee;">₹${formatMoney(
                  total
                )}</td>
              </tr>
            </tfoot>
      ...
      <div style="background-color: #f1f5f9; padding: 16px; text-align: center; font-size: 12px; color: #94a3b8;">
        &copy; ${new Date().getFullYear()} Readify All rights reserved.
      </div>
    </div>
  `;
}
